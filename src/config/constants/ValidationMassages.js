class ValidationMassages{
    static ScessfullyRetrived="# Data retrived Scessfuly ";
    static FaildRetriveData="# Faild retriving Data ";
    static ScessfulyInserted = "# Data Inserted Scessfuly ";
    static FaildInsertingData = "# Faild Inserted Data ";
    static ScessfulyUpdated = "# Data Updated Scessfuly ";
    ...
    static IsAlreadyUpdated = "# Model is Already Updated";
}
